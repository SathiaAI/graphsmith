...
| A5 — Malicious BYO test / external tool (§17 seam) | YES | runs in I3 sandbox under I5 budgets; results schema-validated, labeled third-party, never control adoption; static screen on candidate content (contract 04 B10) | standard profile makes no network-containment claim; container profile required for stronger claims (I3) |
