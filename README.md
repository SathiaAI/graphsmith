...
**Shipped — v0.3.0: GraphSmith Attestation (GSA).** *MCP connects your agents; GSA proves what they did.* v0.3.0 turns each run into a signed, replayable, tamper-evident **attestation bundle** any CI can verify and any regulator can read — evidence, never a certification. It delivers:
