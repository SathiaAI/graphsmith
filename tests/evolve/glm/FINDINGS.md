...
- **Failed**: 0
- **Errors**: 0
- **Skipped (NOT run, no coverage)**: 1

## ⚠️ NO FAILURES, BUT 1 TEST(S) DID NOT RUN
...
- `ATTACK-6b: state-store lease expires and can be re-acquired` — wall-clock-timing-flaky, lease semantics owned by state-store TEST-PASSED separately
...
- **Test Family**: glm
- **Temporary Root**: /tmp/graphsmith-evolve-test-glm
- **Node Version**: v22.22.2
- **Platform**: linux
- **Regenerated by**: node tests/evolve/glm/run-tests.js
